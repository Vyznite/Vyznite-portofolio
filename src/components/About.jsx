...
export const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900 text-white'>

        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-signature text-white inline border-b-4'>About</p>
            </div>

            <p className='text-xl mt-8 '>
                Mijn naam is Levi Meert. Ik ben 17 jaar oud, kom uit België en ben momenteel een junior full stack developer. Ik ben altijd geïnteresseerd geweest in technologie, vooral programmeren, en daarom heb ik besloten om me hierin te specialiseren. 
